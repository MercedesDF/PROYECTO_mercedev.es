...
<head>
    ...
    <link rel="preload" href="/css/main.css?v=<?php echo $css_v; ?>" as="style">
...
<body id="page-tienda" <?php body_class('theme-body page'); ?>>
    ...
    <aside class="merci-ui" id="merci-ui" aria-label="Asistente virtual Merci">
        ...
        <button class="merci-ui__trigger" aria-controls="merci-message" aria-expanded="false"><img class="merci-ui__avatar" src="/assets/images/Merci-en-la-nube.webp" alt="Interactuar con Merci" width="80" height="80" fetchpriority="low" decoding="async"></button>
    </aside>
    <?php wp_footer(); ?>
</body>
</html>