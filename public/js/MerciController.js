...
class MerciController {
    ...
    _loadStandardKnowledgeBase() {
        ...
        if (path === '/' || path === '/index.html') {
            return [
                '¡Hola! Me llamo Mercí, asistente de mercedev👋',
            ...
            return [
                ...
                'Aquí se guarda el conocimiento inmutable generado mientras se crea el proyecto mercedev.es',
            ...
            return [
                ...
                '¿Quieres hablar, compartir conocimientos, solicitar un servicio... habla con Mercedes-mercedev, el cerebro de la web? 📨',
