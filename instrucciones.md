...
15. **Ritmo y Autorización Estricta (Anti-Anticipación):** Está terminantemente PROHIBIDO escupir o adelantar código de una fase o tarea que no haya sido explícitamente iniciada y autorizada por la desarrolladora. Aunque una tarea figure como "Siguiente paso o deuda" en la bitácora, el asistente no debe correr ni asumir su inicio. El ritmo y la dirección los marca única y exclusivamente la autora tras revisar y consolidar el entorno actual.
