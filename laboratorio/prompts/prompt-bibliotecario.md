...
3. DEBES CERRAR OBLIGATORIAMENTE el bloque YAML con los tres guiones `---` en una línea nueva antes de iniciar el cuerpo del documento. Es vital para el parser.
